...
public class StockWatcher implements EntryPoint {
	...
	private void loadStockWatcher() {
		...
		// Add styles to elements in the stock list tables
		...
		/*Scheduler.get().scheduleDeferred(new ScheduledCommand() {
			   ...
			   public void execute() {
			    try { 
			    Window.alert("Visible:" + signOutLink.isVisible()
			      + "\nEnabled:" + signOutLink.isEnabled() 
			      + "\nAttached:" + signOutLink.isAttached());
			    } catch(Throwable e)
			    {
			     Window.alert("Got some exception:"+e);
			    }
			   }
	...
	private void addStock() {
		...
		// Stock code must be between 1 and 10 characters that are number letters or dots
		...
		// Don't add the stock if a duplicate already exists
	...
	private void displayStock(final String symbol) {
		// If the stock doesnt't exist, add the stock to the table
